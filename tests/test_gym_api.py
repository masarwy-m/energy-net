    ...
    def test_gym_api(self):
        for env_name, env_cfg in single_agent_cfgs.items():
            ...
            for _ in range(NUM_SEEDS):
                ...
                check_env(gym_env(**env_cfg, initial_seed=seed), skip_render_check=False)


# The env checker below was adapted from:
# https://github.com/DLR-RM/stable-baselines3/blob/feat/gymnasium-support/stable_baselines3/common/env_checker.py
