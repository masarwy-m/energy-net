...
class EnergyNetEnv(ParallelEnv):
    ...
    def __init__(self,
        ...
        **kwargs: Any):
        ...
        self.num_entities = len(network_entities)
        ...
        self.entities = {entity.name: entity for _, entity in enumerate(network_entities)}
    ...
    def step(self, actions: dict[str, EnergyAction]):
        ...
        if self.timestep == self.simulation_end_time_step - self.simulation_start_time_step:
